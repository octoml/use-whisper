...
React Hook for Whisper API with speech recorder, real-time transcription and silence removal built-in
...
| apiUrl          | string                                             | 'https://api.openai.com/v1/audio/'             | the endpoint URL                                                                     |
